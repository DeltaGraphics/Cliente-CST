...
const NuestrosTrabajos = () => {
	const images = [ { img: minimi, images: [ minimi, minimi, minimi ], id: "minimi1", title: "Eastwood Center", content: "<p>Eastwood Center is a 46-story glass and steel, 858,000 square foot commercial office building for Eastwood, Ltd.</p><p>The building was built within and above the original six-story Eastwood office building. The 1928 landmark façade was restored and integrated with the tower. The structural frame, standing 598 feet tall, is enclosed with a panelized glass curtain wall system and stainless steel diagrid cladding.</p>", description: "<ul><li>Cliente: Eastwood Ltd.</li><li>Tipo de trabajo: Eastwood Ltd.</li><li>Ubicacion: Eastwood Ltd.</li><li>Servicio: Eastwood Ltd.</li></ul>"}, { img: minimi, id: "minimi1" },  { img: minimi, id: "minimi1" }, { img: minimi, id: "minimi1" }, { img: minimi, id: "minimi1" }, { img: minimi, id: "minimi1" }, { img: minimi, id: "minimi1" }, { img: minimi, id: "minimi1" }, { img: minimi, id: "minimi1" }, { img: minimi, id: "minimi1" }, { img: minimi, id: "minimi1" }, { img: minimi, id: "minimi1" }, { img: minimi, id: "minimi1" }, { img: minimi, id: "minimi1" }, { img: minimi, id: "minimi1" }, { img: minimi, id: "minimi1" }, { img: minimi, id: "minimi1" }, { img: minimi, id: "minimi1" }, { img: minimi, id: "minimi1" }, { img: minimi, id: "minimi1" } ]
