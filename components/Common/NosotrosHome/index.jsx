	...
	return (
        <Container className="nosotros-home">
            ...
            <div className="nosotros-home__content">
                ...
                <p className="nosotros-home__content-subtitle">Somos un proveedor de servicios de tecnología y telecomunicaciones, expertos en diseñar e implementar soluciones para el sector empresarial.</p>
            </div>
        </Container>
	);
};
